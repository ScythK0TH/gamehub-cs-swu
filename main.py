...
regan_url = 'https://raw.githubusercontent.com/ScythK0TH/gamehub-cs-swu/main/regan.txt'
regan_text = requests.get(regan_url)
regan = regan_text.text

surprise_url = 'https://raw.githubusercontent.com/ScythK0TH/gamehub-cs-swu/main/surprise.txt'
